...
export default function Home() {
  return (
    <>
      ...
      {/* COUPLE APP + 4 STEPS */}
      <section id="couple-app" className="max-w-7xl  px-6 py-20">
              ...
              <div className="space-y-0">
                {steps.map((step, index) => (
                  <div key={index} className="flex group">
                    ...
                    <div className="pb-12">
                      <h3 className="font-mulish text-[22px] font-bold mb-2">
                        {step.title}
                      </h3>
      ...
      {/* BLOG */}
      <section id="blog" className="max-w-7xl mx-auto px-6 py-20 items-center">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative items-center">
            ...
            <div className="absolute bg-linear-to-r from-[#BA8EFA] to-[#863AC1] bottom-10  z-30 text-white p-1 rounded-full w-50 h-50 flex flex-col items-center justify-center text-center shadow-lg left-1/4">
              <span className="font-mulish font-bold text-[42px] ">1,485+</span>
